...
sys.stdout.write('\x1b]2; Mr.Dark Cracking \x07')
os.system('xdg-open ')
time.sleep
# -------------(MAIN LOGO)--------------
def Banner():
    ...
    ╚════════════════════════════════╝
   ╔══════════════════════════════════════════════════╗
   ║ {green}CREATED BY → {cyan}MR.DARK HCKTVST{white}                     ║
   ║ {green}CREATED-TIME → {cyan}Monday, November 23, 2024{white}         ║
   ║ {green}GITHUB → {cyan}https://github.com/Darkness1268 {white}        ║
   ║ {green}FACEBOOK → {cyan}https://www.facebook.com/MrDarkHcktvst{white}║
   ╚══════════════════════════════════════════════════╝
{red}{green}Mode{red}: {cyan}\033[47mFacebook Crack{white}{red} 
{red}
'''
...
def XYZ():
    print(Banner())
    print(f"{cyan}[{green}1{cyan}] {white}File Cloning\n{cyan}[{green}2{cyan}] {white}Number Cloning")
...
def get_password_list():
    ...
    print(f"{red}[{green}1{red}] {white}Auto Pass\n{red}[{green}2{white}{red}[{green}⛖{red}]{white} {red}{green}Mode{white}{red}: {cyan}\033[47mFacebook Crack{white}{red} ] {white}Choose Pass")

    choice = input(f'{cyan}[{green}➤]{cyan} {white}Choose Option : \033[1;37m')
